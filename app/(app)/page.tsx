...
import { listarOportunidades, ETAPA, ETAPAS_PRESUPUESTO, NOMBRE_ETAPA } from "@/lib/ghl/oportunidades";
...
export default async function DashboardPage() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-sky-200 via-sky-100 to-white">
            ...
            <main className="mx-auto max-w-xl px-4 pb-28 pt-6 sm:px-6">
                <h1 className="text-2xl font-semibold tracking-tight text-[#15375A]">Tus visitas</h1>
                ...
                <div className="mt-6 space-y-6">
                    {ORDEN_ETAPAS.map((etapaId) => {
                        ...
                        return (
                            <section key={etapaId}>
                                <h2 className="mb-2 text-sm font-medium text-slate-500">{NOMBRE_ETAPA[etapaId]}</h2>
                                ...
                                {deEstaEtapa.length === 0 ? (
                                    ...
                                    <div className="space-y-3">
                                        {deEstaEtapa.map((op) => (
                                            ...
                                            >
                                                <p className="font-medium text-slate-900">{op.comunidadNombre ?? op.name}</p>
